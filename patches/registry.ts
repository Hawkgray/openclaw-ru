...
const LAZY_LOCALE_REGISTRY: Record<LazyLocale, LazyLocaleRegistration> = {
  "zh-CN": { exportName: "zh_CN", loader: () => import("../locales/zh-CN.ts") },
  "zh-TW": { exportName: "zh_TW", loader: () => import("../locales/zh-TW.ts") },
  "pt-BR": { exportName: "pt_BR", loader: () => import("../locales/pt-BR.ts") },
  de: { exportName: "de", loader: () => import("../locales/de.ts") },
  es: { exportName: "es", loader: () => import("../locales/es.ts") },
  ru: { exportName: "ru", loader: () => import("../locales/ru.ts") },
};
...
export function resolveNavigatorLocale(navLang: string): Locale {
  if (navLang.startsWith("zh")) return navLang === "zh-TW" || navLang === "zh-HK" ? "zh-TW" : "zh-CN";
